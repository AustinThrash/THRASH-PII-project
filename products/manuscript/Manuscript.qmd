...
***\* Any section past results has not been modified yet. I only completed the sections required for the first part.***
...
```{r}
knitr::include_graphics(here("results","figures","diabetes-distribution.png"))
```

### BMI Distribution

```{r}
knitr::include_graphics(here("results","figures","BMI-distribution.png"))
```

### PhysHlth Distribution

```{r}
knitr::include_graphics(here("results","figures","PhysHlth-distribution.png"))
```
...
```{r}
knitr::include_graphics(here("results","figures","smoker-distribution.png"))
```
